		...
		<Provider store={Store}>
			<NavigationContainer>
				<Stack.Navigator>
					...
					<Stack.Screen options={{ headerShown: false, headerStyle: {backgroundColor: primary,color: 'white'}, headerTitleStyle: {color: 'white'}, headerBackTitleStyle: {color: 'white'}  }} name="Connexion" component={ConnexionScreen} />
