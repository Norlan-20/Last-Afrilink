    ...
    pages={[
      {
        ...
        image: <Image resizeMode="cover" style={{width: width * 0.7, height: height * 0.30 }} source={require('../assets/onboard1.png')} />,
        title: 'Onboarding 1',
        subtitle: 'Done with React Native Onboarding Swiper',
    },
    {
        backgroundColor: '#F5F5F5',
        image: <Image resizeMode="cover" style={{width: width * 0.7, height: height * 0.30 }} source={require('../assets//onboard2.png')} />,
        title: 'Onboarding 2',
        subtitle: 'Done with React Native Onboarding Swiper',
    },
    {
        backgroundColor: '#ffffff',
        image: <Image resizeMode="cover" style={{width: width * 0.7, height: height * 0.30 }} source={require('../assets//onboard3.png')} />,
        title: 'Onboarding 3',
        subtitle: 'Done with React Native Onboarding Swiper',
    },
    ]}
