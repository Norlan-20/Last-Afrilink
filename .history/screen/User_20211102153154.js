...
const UserScreen = props => {
        ...
        <ScrollView vertical style={{marginTop: height * 0.02,backgroundColor: fond}}>
            <View style={{ flex:1, justifyContent: 'center', alignItems: 'center',marginVertical: 30}} >
                ...
                <View>
                    ...
                    <TouchableOpacity onPress={ () => deconnexion() } style={styles.optionContainerBloc2}>
                        <View style={styles.illustrationContainer}>
    ...
    const deconnexion = async () => {
        ...
        const action = {type: 'ONLINE', value: false};
    ...
    return (
        <View style={styles.container}>
            {/* {<ProfileScreen/>} */}
            {/* {console.log(props)} */}
            {!props.online? <AuthChoiceScreen showConnexionScreen={showConnexionScreen} showInscriptionScreen={showInscriptionScreen} />:<ProfileScreen {...props} /> }
        </View>  
    );
};
...
const mapStateToProps = (state) => {
    return {
        online: state.connectUser.online
    }
}
