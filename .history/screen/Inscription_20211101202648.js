...
const InscriptionScreen = (props) => {
    ...
    const verifyInput = (firstName,lastName,mail,password,password2) => {
        if( lastName=="" || firstName=="" || mail=="" || password=="" || password2=="")
        ...
        <View style={ styles.container }>
            ...
            <ScrollView contentContainerStyle={{ justifyContent: 'center'}} style={styles.formContainer}>
                <View style={styles.formBloc}>
                    ...
                    <Image
                        style={{ width: '100%', height: 200, position: 'relative', top: 30, marginVertical: 20, }}
                    ...
                    <TouchableOpacity onPress={ () => verifyInput(prenom,name,mail,password,passwordConf)} style={ styles.loginButton }>
