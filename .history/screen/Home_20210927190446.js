...
import {View, Text, StyleSheet, StatusBar, Dimensions, ScrollView, TouchableOpacity} from 'react-native';
import { Header, Icon, Image, SearchBar } from 'react-native-elements';
import Categorie from '../component/categorie';
import Produit from '../component/produit';
import { listOfCategories, listOfProduct, listOfProductVedette } from '../API/api';
...
const HomeScreen = props => {
    ...
    useEffect(()=> {
        ...
        listOfProductVedette().then(res => {setVedette(res)});
    },[]);
    ...
    return (
        <View style={styles.container}>
            ...
            <Header
                ...
                rightComponent={<Icon onPress={()=>showCart()} name="cart" type="evilicon" size={40} color="#FFF"/>}
