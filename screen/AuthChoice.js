        ...
        <View style={ styles.container }>
            ...
            <View style={ styles.containerBlock }>
                ...
                <View style={ styles.buttonContainer }>
                    <TouchableOpacity onPress={()=> props.showConnexionScreen()} style={ styles.buttonConnexion }>
                        <Text style={ styles.buttonConnexionText }>Connexion</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={ () => props.showInscriptionScreen() } style={ styles.buttonInscription }>
